...
def test_the_manifest_block_separates_present_usable_and_fully_usable(packaged):
    ...
    # 64 poloidal probes + 11 flux loops since IMPA became its own stage (#305),
    # the phase-reference entries were shot-gated (#857) and the duplicate of
    # Mirnov field 171 stopped being published (#825); was 87, then 76.
