#!/usr/bin/env python3
"""
Mines stability analysis data generated by run_parallel_dcon.py.

Dir structure /srv/vest.filedb/public/{shot}/linear_stability/{time}/{dcon, rdcon, stride}/{nn=1,2,...}/

Extract data as excel 
list of columns:shot, time, ip, q0, q95, betan, ideal_stability, resist_stability, perturbed_energy_n=1,...6, tearing_index_rdcon_n=1,2, tearing_index_stride_n=1,2
"""
import os
import argparse
import pandas as pd
