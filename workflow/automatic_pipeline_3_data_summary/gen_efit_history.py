"""Compatibility materializer for the canonical equilibrium-global summary.

The former EFIT g/m/a FileDB scan duplicated the equilibrium-global history.
This wrapper now exports the canonical database preset instead.
"""
...
def generate_efit_history_excel(
    ...
    *,
    ...
    frame = database.summary(
        shot_range, preset="equilibrium_global", source=source
    )
