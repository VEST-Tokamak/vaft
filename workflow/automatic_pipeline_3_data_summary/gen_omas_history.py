"""Materialize the canonical per-shot operational overview.

Legacy FileDB artifact-count columns are intentionally omitted: the database is
the source of truth, and local file presence is not scientific shot metadata.
"""
...
OUTPUT_FILENAME = "omas_history.xlsx"
...
def generate_omas_history_excel(
    ...
    *,
    ...
    frame = database.summary(shot_range, preset="shot_overview", source=source)
    definition = get_summary_preset("shot_overview")
