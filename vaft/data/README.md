...
| `samples/48224/` | `manifest.yaml`, `omas.json.gz` | Repository-only kinetic slice (300 ms): the `kineticEfit/` ODS gzipped byte for byte, plus a manifest listing its three equilibria (`vaft.omas.sample_equilibria(48224)`) |
