...
_EXPORT_MAP = {
    ...
    "EFITConstraintConfig": (".efit_config", "EFITConstraintConfig"),
    "EFIT_FAILURE_CODES": (".efit_status", "EFIT_FAILURE_CODES"),
    "EFITInputs": (".efit", "EFITInputs"),
    "EFITInitializationConfig": (".efit_config", "EFITInitializationConfig"),
    "EFITNumericsConfig": (".efit_config", "EFITNumericsConfig"),
    "EFITProfileConfig": (".efit_config", "EFITProfileConfig"),
    "EFITResult": (".efit", "EFITResult"),
    "EFITScientificConfig": (".efit_config", "EFITScientificConfig"),
    "EFITSliceStatus": (".efit_status", "EFITSliceStatus"),
    "EFITValidationConfig": (".efit_status", "EFITValidationConfig"),
    ...
    "apply_temporal_continuity": (".efit_status", "apply_temporal_continuity"),
    ...
    "efit_parameter_grid": (".efit_config", "efit_parameter_grid"),
    ...
    "validate_efit_slice": (".efit_status", "validate_efit_slice"),
