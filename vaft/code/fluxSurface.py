...
class fluxSurfaces(SortedDict):
        ...
        for k, item1 in enumerate(CS):
            ...
            if levels_psi[k] == self.PSIaxis:
                ...
                for k1 in index:
                    ...
                    X = max(abs(integrate.cumulative_trapezoid(integrate.cumulative_trapezoid(t, l, initial=0), l)))
    ...
    def surfAvg(self, function=None):
        ...
        if False and 'PPRIME' in self['avg'] and 'F' in self['avg'] and 'FFPRIM' in self['avg']:
            ...
            self['avg']['ip'] = integrate.cumulative_trapezoid(self['avg']['dip/dpsi'], self['geo']['psi'], initial=0)
        else:
        ...
        self['geo']['phi'] = (
            self._cocos['sigma_Bp']
            * self._cocos['sigma_rhotp']
            * integrate.cumulative_trapezoid(self['avg']['q'], self['geo']['psi'], initial=0)
            * (2.0 * np.pi) ** (1.0 - self._cocos['exp_Bp'])
        )
    ...
    def surface_integral(self, what):
        ...
        """
        return integrate.cumulative_trapezoid(self['avg']['vp'] * self['avg']['1/R'] * what, self['geo']['psi'], initial=0) / (2.0 * np.pi)
    ...
    def volume_integral(self, what):
        ...
        :return: array of the integration from core to edge
        """
        return integrate.cumulative_trapezoid(self['avg']['vp'] * what, self['geo']['psi'], initial=0)
...
#     OMFIT['test'] = OMFITgeqdsk('/../data/g039915.00317')
