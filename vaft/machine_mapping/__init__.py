...
_EXPORT_MAP = {
    ...
    "hard_x_rays_from_flux_csv": (".hard_x_rays", "hard_x_rays_from_flux_csv"),
    "load_hxr_flux_csv": (".hard_x_rays", "load_hxr_flux_csv"),
    "load_hxr_raw_csv": (".hard_x_rays", "load_hxr_raw_csv"),
    "resolve_hxr_time_alignment": (".hard_x_rays", "resolve_hxr_time_alignment"),
    ...
    "known_magnetics_faults": (".magnetics", "known_magnetics_faults"),
    "magnetics_wiring_for_shot": (".magnetics", "magnetics_wiring_for_shot"),
