---
title: "Formula reference: green"
author: VEST team
date: 2026-09-02 10:13
category: guide
layout: post
permalink: /reference/formula/green/
guide:
  architecture: Generated per-function reference for vaft.formula.green, read from the standardized docstrings (issue 248).
  prerequisites: None.
...
{% assign category = site.data.formula_catalog.categories | where: "name", "green" | first %}
{% assign entries = site.data.formula_catalog.formulas | where: "category", "green" %}

This page is generated from the docstrings of
[`vaft/formula/green.py`](https://github.com/VEST-Tokamak/vaft/blob/develop/vaft/formula/green.py):
