...
| `linux.sh` | The same build, against distribution packages. Names what is missing rather than installing it, and defaults to `--codes neo,tglf`, which is what `install/check_gacode.py` requires. |
