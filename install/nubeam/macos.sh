...
it removes only generated output and installed files, driven by the manifest
this script writes.
...
# Generated by VAFT install/nubeam/macos.sh; removed by install/nubeam/uninstall.sh.
