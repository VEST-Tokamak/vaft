...
#
# Usage:
#   bash install/nubeam/macos.sh --nubeam-root PATH --accept-ntcc-terms [--resume]
#
...
usage() {
  cat <<'EOF'
Usage: bash install/nubeam/macos.sh --nubeam-root PATH --accept-ntcc-terms [--resume]
...
# Generated by VAFT install/nubeam/macos.sh; removed by uninstall.sh.
