---
title: "Formula reference: statistics"
author: VEST team
date: 2026-09-02 10:15
category: guide
layout: post
permalink: /reference/formula/statistics/
guide:
  architecture: Generated per-function reference for vaft.formula.statistics, read from the standardized docstrings (issue 248).
  prerequisites: None.
...
{% assign category = site.data.formula_catalog.categories | where: "name", "statistics" | first %}
{% assign entries = site.data.formula_catalog.formulas | where: "category", "statistics" %}

This page is generated from the docstrings of
[`vaft/formula/statistics.py`](https://github.com/VEST-Tokamak/vaft/blob/develop/vaft/formula/statistics.py):
