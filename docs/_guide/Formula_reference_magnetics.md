---
title: "Formula reference: magnetics"
author: VEST team
date: 2026-09-02 10:16
category: guide
layout: post
permalink: /reference/formula/magnetics/
guide:
  architecture: Generated per-function reference for vaft.formula.magnetics, read from the standardized docstrings (issue 248).
  prerequisites: None.
...
{% assign category = site.data.formula_catalog.categories | where: "name", "magnetics" | first %}
{% assign entries = site.data.formula_catalog.formulas | where: "category", "magnetics" %}

This page is generated from the docstrings of
[`vaft/formula/magnetics.py`](https://github.com/VEST-Tokamak/vaft/blob/develop/vaft/formula/magnetics.py):
