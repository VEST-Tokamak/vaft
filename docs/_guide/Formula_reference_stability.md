---
title: "Formula reference: stability"
author: VEST team
date: 2026-09-02 10:12
category: guide
layout: post
permalink: /reference/formula/stability/
guide:
  architecture: Generated per-function reference for vaft.formula.stability, read from the standardized docstrings (issue 248).
  prerequisites: None.
...
{% assign category = site.data.formula_catalog.categories | where: "name", "stability" | first %}
{% assign entries = site.data.formula_catalog.formulas | where: "category", "stability" %}

This page is generated from the docstrings of
[`vaft/formula/stability.py`](https://github.com/VEST-Tokamak/vaft/blob/develop/vaft/formula/stability.py):
