---
title: "Formula reference: equilibrium"
author: VEST team
date: 2026-09-02 10:11
category: guide
layout: post
permalink: /reference/formula/equilibrium/
guide:
  architecture: Generated per-function reference for vaft.formula.equilibrium, read from the standardized docstrings (issue 248).
  prerequisites: None.
...
{% assign category = site.data.formula_catalog.categories | where: "name", "equilibrium" | first %}
{% assign entries = site.data.formula_catalog.formulas | where: "category", "equilibrium" %}

This page is generated from the docstrings of
[`vaft/formula/equilibrium.py`](https://github.com/VEST-Tokamak/vaft/blob/develop/vaft/formula/equilibrium.py):
