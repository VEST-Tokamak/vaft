...
| `_data/formula_catalog.yml` | Generated by `python -m vaft.formula.catalog --output ...` on `develop`; rendered by the `_guide/Formula_reference*.md` pages. Never edit by hand. |
| `_data/vest_diagnostics.yml` | Generated by `python -m vaft.machine_mapping.registry --output ...`; rendered by `_guide/VEST_diagnostics.md`. |
